<div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-info text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Delivery Type</li>
        </ol>
    </nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="delivery_name" placeholder="Delivery Name">
                            @error('delivery_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" wire:model="delivery_amount" placeholder="Delivery Amount">
