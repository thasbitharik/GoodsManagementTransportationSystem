<div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-info text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Size</li>
        </ol>
    </nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="size_name" placeholder="Size Name">
                            @error('size_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="dimension" placeholder="Size Dimensions">
                            @error('dimension')
                            <span class="text-danger text-sm">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" wire:model="size_amount" placeholder="size Amount">
                            @error('size_amount')
                            <span class="text-danger text-sm">{{ $message }}</span>
                            @enderror
